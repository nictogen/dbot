...
interface ISaveable {
    ...
    companion object {
        ...
        inline fun <reified T : ISaveable> loadData(folderPath: String, list: ArrayList<T>) : ArrayList<T> {
            ...
            files?.forEach { file ->
                ...
                while (scanner.hasNextLine()) {
                    ...
                    data[TessUtils.getKey(s)] = TessUtils.getValue(s)
                }
                scanner.close()
    ...
    fun saveData() {
        val data = HashMap<String, String>()
        this::class.memberProperties.forEach { property -> data[property.name] = property.getter.call(this).toString() }
